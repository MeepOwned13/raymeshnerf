"""
Based on code from DTUeval-python (MIT License): https://github.com/jzhangbs/DTUeval-python/tree/master

Modifications:
- Adapted code to folder structure of RayMeshNeRF project
"""
...
if __name__ == '__main__':
    ...
    obs_mask_file = loadmat(root_dir / f'data/DTU/scan{args.scan}/ObsMask{args.scan}_10.mat')
    ...
    stl_pcd = o3d.io.read_point_cloud(root_dir / f'data/DTU/scan{args.scan}/stl{args.scan:03d}_total.ply')
    ...
    ground_plane = loadmat(f'data/DTU/scan{args.scan}/Plane{args.scan}.mat')['P']
