...
def sample_ray_uniformally(origins: Tensor, directions: Tensor, near: float, far: float, num_samples: int, perturb=True) -> tuple[Tensor, Tensor, Tensor]:
...
def sample_ray_hierarchically(origins: Tensor, directions: Tensor, num_samples: int, bins: Tensor, weights: Tensor, deterministic: bool = False) -> tuple[Tensor, Tensor, Tensor]:
